        ...
        <div className="doctor--card">
            <div className="doctor--card-body">
                ...
                <div className="doctor--card-footer">
                    ...
                    <button onClick={() => handleAppointment(doctor)} className="doctor--card-button">
...
// PatientDoctorSearch component definition
const PatientDoctorSearch = () => {
    const { doctorsList, filteredDoctors, specializations, organizations, locations, setFilteredDoctors, filters, setFilters, setSelectedDoctor } = useContext(PatientContext);
